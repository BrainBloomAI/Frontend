...
import { isAuthenticated, staffSignup } from "@/app/actions"
import { useFormState } from "react-dom"
import Alerts from "@/app/lib/ui/alerts"

export default function Signup() {
	const [state, action] = useFormState(staffSignup, undefined)
	...
	return (
		<>
			<div className="relative grow flex flex-col">
				<h1 className="font-bold text-2xl pb-2">Staff Signup</h1>
